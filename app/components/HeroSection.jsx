    ...
    <div className="pb-20">
      <div className="grid grid-cols-1 lg:grid-cols-3 items-center mb-4">
        <div className="col-span-2 flex items-center">
          <h1 className="text-3xl lg:text-5xl font-extrabold text-white whitespace-nowrap">
            ...
            <div className="flex gap-2 ml-4">
              <div className="cursor-pointer" onClick={() => openInNewTab('https://github.com/ashuppal')}>
                <Image alt="GitHub logo" src={GithubIcon} width={30} height={40} layout="fixed" />
              </div>
              <div className="cursor-pointer" onClick={() => openInNewTab('https://www.linkedin.com/in/ashwini-uppal')}>
                <Image alt="LinkedIn logo" src={LinkedinIcon} width={28} height={30} layout="fixed" />
              </div>
            </div>
          </div>
